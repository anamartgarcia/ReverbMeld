...
#[derive(Debug)]
pub struct ReverbMeldProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ReverbMeldProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ReverbMeld processing");
    
    let mut processor = ReverbMeldProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ReverbMeldProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ReverbMeldProcessor::new(false);
